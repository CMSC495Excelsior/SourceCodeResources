...
/*
    Filename: ReportGUI_ConvenienceMethods.java
    Author: Stephen James
    Date: 10/3/18

    Class objective: To create a Java Class that will be used for creating various JavaFX components. This class
                     will make creating VBoxes, HBoxes, Labels, TexFields and BorderPanes much easier in all other classes.
 */

public class ReportGUI_ConvenienceMethods {
    ...
    public static TextField createTextField(TextField textField, int columnCount, double maxWidth,
        ...
        textField = new TextField(ReportGUI_StartPage.getName());
